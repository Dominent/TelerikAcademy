 window.onload = function () {
     ...
     solve()('book-items-container', 'book-details-container')
     ...
     booksListTemplate = Handlebars.compile((document.getElementById('book-items-container')).innerHTML);
     bookDetailsTemplate = Handlebars.compile((document.getElementById('book-details-container')).innerHTML);
