namespace Dealership.Common
{
    public class Constants
    {
        ...
        //Wheels
        public const int MotorcycleWheelsCount = 2;
        public const int CarWheelsCount = 4;
        public const int TruckWheelsCount = 8;

        public const int VipMaxVehicles = 5;

        public const string InvalidRoleInput = "Invalid Role Input!";
    }
}
